...
public class Constants {
    ...
    static {
        WEEKDAY_MAP.put("Astelehena", CLOSED);
        WEEKDAY_MAP.put("Asteartea", CLOSED);
        WEEKDAY_MAP.put("Asteazkena", CLOSED);
        WEEKDAY_MAP.put("Osteguna", CLOSED);
        WEEKDAY_MAP.put("Ostirala", CLOSED);
        WEEKDAY_MAP.put("Larunbata", OPEN);
        WEEKDAY_MAP.put("Igandea", OPEN);
    }
