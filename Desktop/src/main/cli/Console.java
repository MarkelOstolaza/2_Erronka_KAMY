...
public class Console extends Menus {
    ...
    /** Currently selected week's dates (Monday through Sunday). */
    public static List<LocalDate> currentWeekDates = new ArrayList<>();
    ...
    public void run() {
        ...
        while (state != Menu.EXIT) {
            ...
            state = switch(state) {
                ...
                case WEEK_REFERENCE_DATE_MENU -> handleWeekReferenceDateMenu(true);
